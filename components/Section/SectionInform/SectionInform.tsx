...
const SectionInform = () => {
  return (
    <section className="relative">
      ...
      <div>
        <Image
          className="w-full max-360:h-[500px]  max-768:h-[500px] max-1024:h-[650px] h-[650px]"
          alt="photo"
          sizes=""
          src={photo}
          loading="lazy"
      ...
      <div className="absolute top-0  w-full text-center flex justify-center mt-[89px] max-360:mt-[40px]">
        <div className="max-w-[380px] w-full font-nunito text-white">
          ...
          <div className="mt-9 max-360:mt-8">
